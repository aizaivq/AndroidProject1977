...
public class NotifyDeleteActivity extends BaseActivity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() { 
        public void onServiceConnected(ComponentName className, IBinder service) { 
        	mBinder = (RKUpdateService.LocalBinder)service;
						System.out.println("ota deletePackage: ");
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mPath = startIntent.getStringExtra("path");
    			System.out.println("ota flag 1=UPDATE_SUCCESS 2=UPDATE_FAILED: " + flag );
    			System.out.println("ota mPath: " + mPath );
        ...
        if(flag == RKUpdateService.UPDATE_SUCCESS) {
        	text.setText(getString(R.string.update_success) + getString(R.string.deleting_package));
