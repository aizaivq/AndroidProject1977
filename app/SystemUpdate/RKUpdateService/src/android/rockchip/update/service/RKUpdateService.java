...
public class RKUpdateService extends Service {
    ...
    ***********************************************************************************************************************/
    public static String getRemoteUri() {
    	Log.i(TAG, "http://" + getRemoteHost() + "/OtaUpdater/android?product=" + getOtaProductName() + "&version=" + getSystemVersion()
    ...
    public static String getRemoteUriBackup() {
    	Log.i(TAG, "http://" + getRemoteHostBackup() + "/OtaUpdater/android?product=" + getOtaProductName() + "&version=" + getSystemVersion()
		+ "&sn=" + getProductSN() + "&country=" + getCountry() + "&language=" + getLanguage());
    ...
    private void startNotifyActivity() {
		...
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		System.out.println("uri: " + mTargetURI);
		System.out.println("mOtaPackageLength: " + mOtaPackageLength);
		System.out.println("mOtaPackageName: " + mOtaPackageName);
		System.out.println("mOtaPackageVersion: " + mOtaPackageVersion);
		System.out.println("mSystemVersion: " + mSystemVersion);
