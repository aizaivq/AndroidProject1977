...
public class CameraTextureView extends TextureView implements TextureView.SurfaceTextureListener,ICamera{
    ...
    private void setCameraParms() {
       ...
       // myParam.setPreviewSize(previewSize.width, previewSize.height);
        ...
        myParam.setFocusMode(FOCUS_MODE_CONTINUOUS_PICTURE);
